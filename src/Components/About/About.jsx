...
I am always excited to take on new challenges and contribute to innovative projects. Let's connect and build something amazing together!</p>
                ...
                <div className="about-skills">
                    ...
                    <div className="about-skill"><p>DSA</p><hr style={{width:"30%"}} /></div>
                    <div className="about-skill"><p>Python</p><hr style={{width:"90%"}} /></div>
                    <div className="about-skill"><p>C</p><hr style={{width:"86%"}} /></div>
                    <div className="about-skill"><p>UX/UI principles</p><hr style={{width:"40%"}} /></div>
